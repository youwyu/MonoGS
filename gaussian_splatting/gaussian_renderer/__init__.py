...
def render_pso(
    ...
    ### compute gt depth, rgb, and masks
    gt_depth = torch.from_numpy(viewpoint_camera.depth).to(
    ...
    rgb_pixel_mask = rgb_pixel_mask * viewpoint_camera.grad_mask
