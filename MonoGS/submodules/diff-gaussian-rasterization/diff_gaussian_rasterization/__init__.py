...
def rasterize_gaussians(
    ...
    if pso == None:
        ...
        return _RasterizeGaussians_forward(
            means3D,
            means2D,
            sh,
            colors_precomp,
...
def _RasterizeGaussians_forward(
        means3D,
        means2D,
        sh,
        colors_precomp,
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, depth, opacity, n_touched = _C.rasterize_gaussians_pso(*args)
...
class GaussianRasterizer(nn.Module):
    ...
    shs = None, colors_precomp = None, scales = None, 
    rotations = None, cov3D_precomp = None, theta=None, rho=None, 
    pso=None, gt_depth=None, depth_mask=None, gt_image=None, rgb_mask=None):
